...
if( isServiceWorkerContext() ) {
    self.importScripts('sw_configuration.js');
}
/*
...
if( isServiceWorkerContext() ) {
    ...
    console.groupCollapsed("[SW]", "Console Examples")

        console.assert("Assert" === "Assert")
        console.debug("Debug")
        console.dir(sw)
        console.error("Error")
        console.info("Info")
        ...
        console.groupCollapsed("Collapsed SW Group")
            console.log(1)
            console.log(2)
            console.log(3)
        console.groupEnd()
        
        console.group("SW Group")
            console.log(1)
            console.log(2)
            console.log(3)
        console.groupEnd()
    ...
    console.groupCollapsed("SW Group")
    console.log(1)
    console.log(2)
    console.log(3)
    console.groupEnd()
